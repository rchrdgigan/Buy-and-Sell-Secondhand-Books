                ...
                <div class="card card-primary card-outline">
                    <div class="input-group-prepend">
                      ...
                      <div class="dropdown-menu" style="">
                        <a class="dropdown-item" href="#"><i class="fas fa-eye text-primary"></i> View Shop</a>
                    ...
                    <h3 class="profile-username text-center mb-3">First Middle Last</h3>
                      ...
                      <ul class="list-group list-group-unbordered">
                        ...
                        <li class="list-group-item">
                        <b><i class="fas fa-house-user"></i> Address</b> <a class="float-right">Brgy. Palale</a>
                        </li>
                        <li class="list-group-item">
                        <b><i class="far fa-address-book"></i> Contact Number</b> <a class="float-right">09312312312</a>
                        </li>
                        <li class="list-group-item">
                        <b><i class="fas fa-envelope"></i> Email address</b> <a class="float-right">example@email.com</a>
                        </li>
                        <li class="list-group-item">
                        <b><i class="fas fa-info-circle"></i> Status</b> <a class="float-right bg-success rounded-circle">active</a>
                        </li>
                      </ul>
