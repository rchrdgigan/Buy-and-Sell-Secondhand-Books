...
<div class="container">
    <div class="row">
        <div class="col-12">
        <h6 class="float-right"><a href="{{route('my.purchase')}}">My Purchase</a> / In-process Order</h6>
        </div>
    </div>
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="card">
                ...
                <h2>In-process Order</h2>
                    <table class="table table-responsive table-striped">
                        ...
                        <tbody>
                        @foreach($user_order->where('status','processing')->sortDesc() as $data)   
                            <tr>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="form-group h6">
                        <b>Status : </b> <span class="text-info" id="status"></span>
                    </div>  
                </div>
            </div>
        </div>
