            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="brgy" class="col-md-4 col-form-label text-md-right">{{ __('Baranggay') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="street" class="col-md-4 col-form-label text-md-right">{{ __('House No. / Street') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="purok" class="col-md-4 col-form-label text-md-right">{{ __('Purok') }}</label>
